    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.categoryservice', verbose_name='Категория товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produced', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='service.service', verbose_name='Услуга')),
            ],
            options={
