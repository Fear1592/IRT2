# Generated by Django 4.1.7 on 2023-04-21 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.categoryshop', verbose_name='Категория товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choices', to='shop.product', verbose_name='Продукт')),
            ],
            options={
